...
startGrid file = array ((0,0), (readWidth file, readHeight file)) [((0,0),"w"),((0,1),"w"),((0,2),"w"),((0,3),"w"),((0,4),"w"),
...
readWidth (x:y:xs) = read x :: Int

readHeight :: [String] -> Int
readHeight (x:y:xs) = read y :: Int
